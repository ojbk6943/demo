...
from gui_interface.common.training_resource.TrainingResource import TrainingResource
from gui_interface.util.Service import Service
from gui_interface.util.Utility import Utility

marketing_query_data = Utility.read_json("../../test_data/training_resource/training_resource_data")
