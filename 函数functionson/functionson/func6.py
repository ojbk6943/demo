...
students = [
    {'age':18,'name':'tom', 'gender':'male'},
    {'age':20,'name':'duoyu', 'gender':'female'},
    {'age':18,'name':'xiazhu', 'gender':'male'},
    {'age':21,'name':'zhuangqiang', 'gender':'female'},
    {'age':22,'name':'dacongming', 'gender':'male'},
]
